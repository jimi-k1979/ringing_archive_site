<style type='text/css'>
.text {
	font: 1em Arial, Helvectica, sans-serif;
	color:#000000;
	padding:5px;
}
...
<!-- code snippet for making an improved stats access panel -->
